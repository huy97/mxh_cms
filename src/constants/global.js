...
export const CREATE_USER_URL = '/v2/admin/user/create';
export const UPDATE_USER_URL = '/v2/admin/user/update';
export const DELETE_USER_URL = '/v2/admin/user/delete';
export const UPDATE_USERROLE_URL = '/v2/admin/user/update-role';
export const LIST_USER_URL = '/v2/admin/user/get';
...
export const UPDATE_ROLE_URL = '/v2/admin/role/update';
export const DELETE_ROLE_URL = '/v2/admin/role/delete';
...
export const CHANGE_PWD_URL = "/v2/admin/change-password"
